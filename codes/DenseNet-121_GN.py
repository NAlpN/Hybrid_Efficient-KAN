...
CONFIG = {
    ...
    "save_dir": "experiments/densenet_frozen_gaussian"
}
...
class HybridDenseNetKAN(nn.Module):
    def __init__(self, num_classes=3):
        ...
        # 3072 boyutlu vektörü 64'e sıkıştır
...
pd.DataFrame({'True_Label': all_true_labels, 'Pred_Label': all_pred_labels}).to_csv(os.path.join(CONFIG['save_dir'], 'preds_densenet_frozen_gaussian.csv'), index=False)